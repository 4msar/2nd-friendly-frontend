            ...
            <ul className="nav align-items-center justify-content-center">
              ...
              <li className="nav-item">
                <a className="nav-link" href="#">
                  <i className="fas fa-headset me-2"></i>Call us now: +1 235-869-328
                </a>
              </li>
            </ul>
            {/* <!-- Navbar top Right--> */}
              ...
              <ul className="navbar-nav navbar-nav-scroll">
                ...
                <li className="nav-item dropdown">
                  ...
                  <a className="nav-link" href="reservation">
                    <i className="bi bi-speedometer2 me-2"></i>Reservation
                  </a>{" "}
                </li>
                <li className="nav-item dropdown">
                  {" "}
                  <a className="nav-link" href="message">
                    <i className="bi bi-speedometer2 me-2"></i>Message
                  </a>{" "}
                </li>
                <li className="nav-item dropdown">
                  {" "}
                  <a className="nav-link" href="support">
                    <i className="bi bi-speedometer2 me-2"></i>Support
                  </a>{" "}
                </li>
              </ul>
            </div>
