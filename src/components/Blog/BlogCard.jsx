  ...
  return (
    ...
    >
      <div className="carousel-inner">
        {item.images.length > 0 && item.images.map((data) => (
            <div className={`carousel-item ${data.class}`}>
            <img
            src={data.img.src}
    ...
    <div className="card-body px-0">
      ...
      <p className="text-truncate-2">
        ...
        farther of my no colonel shyness. Such on help ye some door if
        in. Laughter proposal laughing any son law consider. Needed
        except up piqued an.
      </p>
