                    ...
                    <div className="row g-4">
                        <div className="col-sm-6 col-lg-4 col-xl-4">
                            <div className="card shadow">
                                <div className="position-absolute top-0 start-100 translate-middle bg-danger rounded-circle lh-1 h-10px p-0">
                                    <a href="#"> <i className="bi bi-x text-white fs-5"></i></a>
                                </div>
                                <img src="../assets/img/category/1.jpg" className="rounded-top-2" alt="course image"/>
                                <div className="card-body pb-0">
                                    <h5 className="card-title fw-normal"><a href="../listing-detail.php" target="_blank">Burger King</a></h5>
                                    <p className="mb-2 text-truncate-2">Burger King is a global fast-food restaurant chain that specializes in hamburgers, fries, and other fast-food items.</p>
                                    {/* <!-- Rating star --> */}
                                    <ul className="list-inline mb-0">
                                        ...
                                        <li className="list-inline-item ms-2 h6 fw-light mb-0">5.0 (1.5k Reviews) </li>
                                    </ul>
                                </div>
                                {/* <!-- Card footer --> */}
                                <div className="card-footer pt-0 pb-3">
                                    ...
                                    <div className="d-flex justify-content-between">
                                        <span className="h6 fw-light mb-0"><span className="fw-bold text-danger">Closed</span> until 11:00 PM</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="col-sm-6 col-lg-4 col-xl-4">
                            <div className="card shadow">
                                ...
                                <img src="../assets/img/category/3.jpg" className="rounded-top-2" alt="course image"/>
                                <div className="card-body pb-0">
                                    <h5 className="card-title fw-normal"><a href="../listing-detail.php" target="_blank">Christian Brothers</a></h5>
                                    <p className="mb-2 text-truncate-2">Christian Brothers Automotive is a chain of automotive repair shops that operates across the United States.</p>
                                    {/* <!-- Rating star --> */}
                                    <ul className="list-inline mb-0">
                                        <li className="list-inline-item me-0 small"><i className="fas fa-star text-warning"></i></li>
                                        <li className="list-inline-item me-0 small"><i className="fas fa-star text-warning"></i></li>
                                ...
                                <div className="card-footer pt-0 pb-3">
                                    <hr/>
                                    <div className="d-flex justify-content-between">
                                        <span className="h6 fw-light mb-0"><span className="fw-bold text-success">Open</span> until 11:00 PM</span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default UserView(WishList, "Wish List")