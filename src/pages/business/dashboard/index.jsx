            ...
            <div className="row">
              <div className="col-xl-12">
                ...
                <div className="header mt-5">
                  <h5 className="mb-2 mb-sm-0 text-danger pb-0">
                    Recent 5 Support Tickets (s)
                  </h5>
                  <p className="mb-0">
                  ...
                  <table className="table align-middle p-4 mb-0 table-hover border">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <h6 className="mt-2 mt-lg-0 mb-0">
                            <a href="support-detail.php">Feature Request</a>
                          </h6>
                        </td>
                        <td>#102356</td>
                        <td className="text-center text-sm-start">
                      ...
                      <tr>
                        ...
                        <td>
                          <h6 className="mt-2 mt-lg-0 mb-0">
                            <a href="support-detail.php">Data Loss/Recovery</a>
                          </h6>
                        </td>
                        <td>#102356</td>
                        <td className="text-center text-sm-start">
