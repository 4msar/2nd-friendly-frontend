...
const SignUpCustomer = () => {
  ...
  const handleSignUpCustomer = async (event) => {
    ...
    const res = await axios
      .post(`${API_URL}/customer-registration`, payload)
      .then((data) => {
                ...
                <div className="col-sm-10 col-xl-8 m-auto">
                    ...
                    <div className="align-items-center mt-0">
                      <div className="d-grid">
                        <Button
                          ...
                          onClick={(e) => handleSignUpCustomer(e)}
                        >
                          Sign Up
                        </Button>
                      </div>
                  ...
                  <div className="mt-4 mb-4 text-center">
                    <span>
                      ...
                      <Link href="/sign-in-customer"> Sign in here</Link>
                    </span>
                  </div>
                  ...
                  <div className="align-items-center mt-0">
                    <div className="d-grid">
                      <button className="btn btn-success mb-0" type="submit">
                        {" "}
                        <Link className="text-white" href="/sign-up-business">
                          Business Sign Up
                        </Link>
                      </button>
                    </div>
