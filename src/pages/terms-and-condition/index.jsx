...
const TermsAndCondition = () => {
  return (
    <main>
      ...
      <section className="bg-white pt-1 pb-5">
        <div className="container">
          <div className="row">
            <div className="col-lg-12 pb-0">
              <h4 className="fw-normal pb-1">Terms of Service</h4>
              <p>
              ...
              <p>
                ...
                information that they shared and/or collect in&My Website. This
              ...
              <p>
                My Website follows a standard procedure of using log files.
              ...
              <h5 className="mt-4">Cookies and Web Beacons</h5>
              <p>
                Like any other website, My Website uses "cookies". These cookies
              ...
              <h5 className="mt-4">DoubleClick DART Cookie</h5>
              <p>
              ...
              <h5 className="mt-4">Advertising Partners Privacy Policies</h5>
              <p>
              ...
              <h5 className="mt-4">Third-Party Privacy Policies</h5>
              <p>
              ...
              <h5 className="mt-4">GDPR Privacy Policy (Data Protection Rights)</h5>
              <p>
              ...
              <h5 className="mt-4">Children's Information</h5>
              <p>
...
export default PublicView(TermsAndCondition);
