...
const BusinessService = {
  ...
  addRemoveCategory: (data) =>
    commandApi.post("/business/single-subcategory-add-remove", data),

  aboutBusiness: () => commandApi.post("/business/about-the-business-all"),
  aboutBusinessSave: (data) =>
    commandApi.post("/business/about-the-business-save", data),
  amenityAllAndSelected: () =>
    commandApi.post("/business/amenity-all-and-selected"),
  amenityAddRemove: (data) =>
    commandApi.post("/business/single-amenity-add-remove", data),
  operationHours: () =>
    commandApi.post("/business/hours-of-operation-and-extended-closure", {}),
  operationHoursSave: (data) =>
    commandApi.post("/business/hours-of-operation-save", data),
  operationClosureSave: (data) =>
    commandApi.post("/business/hours-of-operation-extended-closure-save", data)
};
