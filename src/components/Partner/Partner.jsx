              ...
              <div className="tiny-slider-inner">
                <Slider {...settings} centerPadding="40px">
                  ...
                  <div key={5} className="item">
                    {" "}
                    <img src={slider5.src} alt="" />{" "}
                  </div>
                  <div key={6} className="item">
                    {" "}
                    <img src={slider6.src} alt="" />{" "}
                  </div>
                  <div key={7} className="item">
                    {" "}
                    <img src={slider7.src} alt="" />{" "}
                  </div>
                </Slider>
              </div>
            </div>
        ...
        <div className="row">
          <div className="col-12 col-md-12 mx-auto">
            <div className="bg-info rounded-3 shadow p-3 p-sm-4 position-relative overflow-hidden">
              ...
              <div className="row">
                <div className="col-md-12 mx-auto text-center py-4 position-relative">
                  {/* <!-- Title --> */}
                  <h2 className="text-white">
                    Subscribe to our Newsletter for Newest Updates
                  </h2>
