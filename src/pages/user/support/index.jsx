                    ...
                    <div className="d-flex justify-content-left">
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb breadcrumb-dots my-0 py-0">
                                <li className="breadcrumb-item">/user/<a href="index">Home</a></li>
            ...
            <div className="row">
                ...
                <div className="col-xl-9">
                    ...
                    <table className="table align-middle p-4 mb-0 table-hover border">
                                ...
                                <tr>
                                    <th scope="col" className="border-0 text-dark">Created at</th>
                                    <th scope="col" className="border-0 rounded-start text-dark">Subject</th>
                                    <th scope="col" className="border-0 text-dark">Ticket</th>
                                    <th scope="col" className="border-0 text-black">Status</th>
                                    <th scope="col" className="border-0 text-black">Updated at</th>
                                    <th scope="col" className="border-0 rounded-end text-dark">Action</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <h6 className="mt-2 mt-lg-0 mb-0"><a href="/user/support-detail">Technical Issue</a></h6>
                                    </td>
                                    <td>
                                        #102356
                                    </td>
                                    ...
                                    <td>May 21, 2023</td>
                                    <td>
                                        <a href="/user/support-detail" className="text-black"><i className="far fa-fw fa-eye"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>January 26, 2024</td>
                                    <td>
                                        <h6 className="mt-2 mt-lg-0 mb-0"><a href="/user/support-detail">Sale Service</a></h6>
                                    </td>
                                    <td>
                                        #102356
                                    </td>
                                ...
                                <tr>
                                    <td>January 26, 2024</td>
                                    <td>
                                        <h6 className="mt-2 mt-lg-0 mb-0"><a href="/user/support-detail">Warranty Claim </a></h6>
                                    </td>
                                    <td>
                                        #102356
                                    </td>
                                ...
                                <tr>
                                    <td>January 26, 2024</td>
                                    <td>
                                        <h6 className="mt-2 mt-lg-0 mb-0"><a href="/user/support-detail">Product Enquiry</a></h6>
                                    </td>
                                    <td>
                                        #102356
                                    </td>
                                ...
                                <tr>
                                    <td>January 26, 2024</td>
                                    <td>
                                        <h6 className="mt-2 mt-lg-0 mb-0"><a href="/user/support-detail">Account Activation</a></h6>
                                    </td>
                                    <td>
                                        #102356
                                    </td>
...
export default UserView(UserSupport, "User Support")