        ...
        <div className="container">
          <div className="row">
            ...
            <div class="card-header border-bottom pb-1 mb-3">
                        ...
                        <div class="opacity-80">Choose type of hour you want to open your business</div>
                    </div>
                    ...
                    <div class="card-header border-bottom pb-1 mb-3 mt-4">
                        ...
                        <div class="opacity-80">Let customers know about temporary or permanent closures to your business</div>
                    </div>
                    <form class="row g-3 needs-validation mt-3" novalidate>
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <div class="form-check form-check-inline text-middle">
                                    <input class="form-check-input" type="radio" id="inlineRadio15" name="inlineRadio"  autofocus required/>
                                    <label class="form-check-label fw-bold text-dark" for="inlineRadio15">
                                        <h5>Temporarily Closed</h5>
                                    </label>
                                    <br/>
                                    <span class="text-opacity-50" >Planning a renovation or extended holiday? Mark your business closed for a short time and set a date to let customers know when you will reopen.Customers can still interact with your busi</span>
                                </div>
                                <ul class="list-group list-group-borderless mt-2 ps-6 border-bottom">
                                    <li class="list-group-item text-dark"><i class="bi bi-star fw-bold"></i> Customers can still interact with your business on 2nd A Friendly.</li>
                                    <li class="list-group-item text-dark"><i class="bi bi-megaphone"></i> We’ll pause your paid products.</li>
                                    <li class="list-group-item text-dark"><i class="bi bi-search"></i> Your business may appear lower in search results while closed.</li>
                                </ul>
                            </div>
                            <div class="col-lg-6 col-sm-12 mt-3">
                                <label for="when_will_your_business_reopen" class="form-label fw-bold text-dark">When will your business reopen? <span class="star">*</span></label>
                                <input type="date" id="when_will_your_business_reopen" class="form-control when_will_your_business_reopen" title="when_will_your_business_reopen" required />
                            </div>
                            <div class="col-lg-12 col-sm-12 mt-3">
                                <label for="additional_details" class="form-label fw-bold text-dark">Additional Details(optional) <span class="star">*</span></label>
                                <textarea type="text" name="additional_details" class="form-control additional_details" style={{height: "100px"}} id="additional_details" placeholder="" required></textarea>
                            </div>
                            <div class="col-md-12 col-sm-12">
                                <div class="form-check form-check-inline text-middle mt-4">
                                    <input class="form-check-input" type="radio" id="inlineRadio16" name="inlineRadio"  autofocus required/>
                                    <label class="form-check-label fw-bold text-dark" for="inlineRadio16">
                                        <h5>Permanently Closed</h5>
                                    </label>
                                    <br/>
                                    <span class="text-opacity-50" >Let your customers know your business is closing permanently.</span>
                                </div>
                                <ul class="list-group list-group-borderless mt-2 ps-6 border-bottom">
                                    <li class="list-group-item text-dark"><i class="bi bi-x-circle-fill fw-bold"></i> You will lose access to your page.</li>
                                    <li class="list-group-item text-dark"><i class="bi bi-house-add-fill"></i> Your other locations will not be affected.</li>
                                </ul>
                            </div>
                            <div class="col-lg-12 col-sm-12 mt-3">
                                <label for="additional_details" class="form-label fw-bold text-dark">Additional Details(optional) <span class="star">*</span></label>
